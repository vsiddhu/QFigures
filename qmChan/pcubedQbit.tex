...
\node[align=left, font = \footnotesize] at (3.75,-3.) () {Schematic
representation of a degradable qubit channel $\BC$ \\ with a qubit complement
$\CC$ and degrading map $\DC$.\\ For details, see Sec. IV.A in Phys. Rev. A 94,
052331 (2016)};
