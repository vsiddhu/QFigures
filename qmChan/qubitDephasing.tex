...
\node[align=left, font = \normalsize] at (1,-1.75) () {Enclosed inside a Bloch
    sphere (in black), an ellipsoid (in red) and line (in blue)\\ representing
    the locus of Bloch vectors of $\BC$ and $\CC$ respectively where $p =
    0.3$};
